      ...
      <div className="flex-grow flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 p-4">
        ...
        <div className="max-w-md w-full bg-white p-6 md:p-8 rounded-lg border border-primary-400 shadow-lg">
          <div className="flex flex-col gap-3 mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Cadastrar-se</h2>
            <p className="text-sm md:text-base">
              Com uma conta, você poderá adotar um pet e transformar a vida dele para melhor!
            </p>
          </div>
          ...
          <form onSubmit={handleSignUp}>
            <div className="mb-4">
              ...
              <input
                ...
                className="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[#7DA632] focus:border-[#7DA632] p-3 md:p-4 text-base md:text-lg"
