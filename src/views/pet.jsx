    ...
    <div className="container mx-auto mt-8 px-4">
      {pet ? (
        <>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="mt-6 md:mt-0 md:ml-8 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <Link
                    to={`/adotar/${pet.id}`}
                    className="bg-[#7DA632] text-white px-6 py-3 rounded-lg w-full sm:w-auto text-center"
                  >
                    Saiba mais
                  </Link>
                </div>
          ...
          <ModalAdocao isOpen={isModalOpen} closeModal={() => setIsModalOpen(false)} pet={pet} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
              {otherPets.map((pet) => (
                <div key={pet.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                  <img src={pet.foto} alt={pet.nome} className="w-full h-32 sm:h-40 object-cover" />
