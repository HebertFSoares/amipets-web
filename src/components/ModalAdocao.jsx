...
export default function ModalAdocao({ isOpen, closeModal, pet, status, adocaoId }) {
  ...
  const statusSteps = [
    ...
    },
    {
      id: 2,
      title: 'Em Análise',
      active: adocaoStatus === 'EM_ANALISE' || adocaoStatus === 'APROVADO',
    },
      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-2xl sm:max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <div className="mb-6">
